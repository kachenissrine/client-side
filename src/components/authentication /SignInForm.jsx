            ...
            <div className="w-1/2 h-full flex flex-col p-20 justify-between py-9">
                ...
                <div className="w-full flex flex-col max-w-[550px]">
                    <div className="w-full flex flex-col mb-10">
                        <h3 className="text-3xl font font-semibold mb-4"> Sign In</h3>
                    ...
                    <div className="w-full flex items-center justify-between">
                        <div className="w-full flex items-center">
                            ...
                            <p className="ms-2 text-sm font-normal text-gray-900 dark:text-gray-300">Remember Me</p>
                        </div>
                        <Link to="/forgetpassword">
                            <p className="text-sm text-[#0A65CC] font-medium whitespace-nowrap cursor-pointer underline underline-offset-2">Forget
                                Password</p>
                        </Link>
                    </div>
                ...
                <div className="w-full flex items-center justify-center">
                    <p className="text-sm font-normal ">Don't have Account?
                        <span className="font-semibold text-[#0A65CC] underline underline-offset-2 cursor-pointer">Sign Up for free</span>
                    </p>
