                ...
                <div className="bg-layer-2 py-20 px-20 sm:rounded-lg sm:px-10 justify-between">
                    <div className="mx-auto max-w-lg text-center">
                        ...
                        <p className="mt-4 text-gray-500">
                            We ‘ve sent an verification to <span
                            className="text-sm font-semibold text-black">emailadress@gmail.com</span> to verify your
                            email address and activate you account.
                        </p>
                        ...
                        <div>
                            <p className="tmt-4 text-gray-500">Didn’t recieve any code! <span className="font-semibold text-[#0A65CC] cursor-pointer">Resends</span></p>
                        </div>
